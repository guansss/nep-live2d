...
declare class Live2DModelWebGL {
    ...
    /**
     * @returns The width of model's Live2D drawing canvas, NOT the html canvas element.
     */
    getCanvasWidth(): number;

    /**
     * @returns The height of model's Live2D drawing canvas, NOT the html canvas element.
     */
